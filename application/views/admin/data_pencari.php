                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?=base_url('admin/terima_pendaftaran/') . $r->id_user . '/pencari'?>">
                                ...
                                <button type="button" class="btn btn-danger mt-1 tolak" data-toggle="modal"
                                    data-target="#tolakModel" data-idd="<?=$r->id_user?>">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Detail Akun Pencari
...
<div class="modal fade" id="tolakModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Penolakan Registrasi Pencari Kos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="modal-view">
                ...
                <form method="POST" action="<?=base_url('admin/tolak_pendaftaran_pencari')?>">
