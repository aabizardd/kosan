    ...
    <div id="carouselExampleIndicators" class="carousel slide mt-2 h-50" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?= base_url('asset_admin/upload_kos/') ?><?= $r->foto; ?>" alt="First slide">
            </div>
                ...
                foreach ($result as $r) : ?>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter<?= $r->kode_kamar ?>">Booking Sekarang</a>
                        </div>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalCenter<?= $r->kode_kamar ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="form" action="<?= base_url('pencari/pesan_kamar') ?>" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <div class="mb-2">
                                                    <label for="exampleFormControlInput1">Nama Penghuni</label>
                                                    <input type="tuext" class="form-control" placeholder="Nama Penghuni" name="nama_penghuni">
                                                </div>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    id="datepicker"> -->
                                                    <input type="text" class="form-control datepicker" placeholder="yy/mm/dd" name="tgl_masuk" autocomplete="off">
                                                </div>
